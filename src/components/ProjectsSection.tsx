...
const PROJECTS: ProjectData[] = [
  {
    number: '01',
    category: 'Hackathon · Healthcare AI',
    name: 'MedMentor',
    liveUrl: 'https://github.com/Rohanindia/medmentor',
    githubUrl: 'https://github.com/Rohanindia/medmentor',
    col1Image1: '/medmentor1.svg',
    col1Image2: '/medmentor2.svg',
    col2Image: '/medmentor3.svg',
  },
  {
    number: '02',
    category: 'Hackathon · Multi-Agent AI',
    name: 'SwarmForge',
    liveUrl: 'https://swarm-forge-web.vercel.app',
    githubUrl: 'https://github.com/Rohanindia/-SwarmForge',
    col1Image1: '/swarmforge1.svg',
    col1Image2: '/swarmforge2.svg',
    col2Image: '/swarmforge3.svg',
  },
  {
    number: '03',
    category: 'Hackathon · Sustainability',
    name: 'GreenSense',
    liveUrl: 'https://greensense-app.web.app',
    githubUrl: 'https://github.com/Rohanindia/greensense-carbon',
    col1Image1: '/greensense1.svg',
    col1Image2: '/greensense2.svg',
    col2Image: '/greensense3.svg',
  },
  {
    number: '04',
    category: 'Personal · Healthcare',
    name: 'Smart Med',
    liveUrl: 'https://github.com/Rohanindia',
    githubUrl: 'https://github.com/Rohanindia',
    col1Image1: '/smartmed1.svg',
    col1Image2: '/smartmed2.svg',
    col2Image: '/smartmed3.svg',
  },
];
      ...
      >
          {/* Top row: number + meta + button */}
                  <div className="flex flex-col sm:flex-row items-start sm:justify-between gap-4 sm:gap-6">
                    ...
                    <div className="shrink-0 self-start sm:self-auto pt-1 sm:pt-2 md:pt-3 w-full sm:w-auto flex gap-2">
                      <a
                        href={project.githubUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label={`View ${project.name} on GitHub`}
                        className="inline-flex items-center justify-center rounded-full border border-[#D7E2EA]/30 bg-transparent px-4 py-2 text-xs font-medium uppercase tracking-widest text-[#D7E2EA]/70 transition hover:border-[#D7E2EA]/70 hover:text-[#D7E2EA] hover:scale-[1.03]"
                      >
                        GitHub
                      </a>
          ...
          <div className="flex flex-col gap-3 sm:gap-4 md:gap-5 min-h-0">
            ...
            >
              <img
                ...
                alt={`${project.name} feature preview`}
                className="h-full w-full object-cover"
                loading="lazy"
                draggable={false}
              />
