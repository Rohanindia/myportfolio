...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'rohandevaadiga@gmail.com',
    href: 'mailto:rohandevaadiga@gmail.com',
  },

  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/rohan-devadiga-2b2341337',
    href: 'https://www.linkedin.com/in/rohan-devadiga-2b2341337/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@Rohanindia',
    href: 'https://github.com/Rohanindia',
  },
];
      ...
      <FadeIn delay={0.4} y={20}>
        <div className="mx-auto mt-20 sm:mt-24 md:mt-28 flex max-w-5xl flex-col items-center gap-3 border-t border-[#D7E2EA]/10 pt-8 text-center sm:flex-row sm:justify-between">
          ...
          <span
            ...
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            Designed & built in Hubballi, Karnataka
          </span>
        </div>
      </FadeIn>
    </section>
