...
const ABOUT_TEXT =
  "I'm an MCA candidate at KLE Technological University with hands-on research experience in Large Language Models, Retrieval-Augmented Generation, and AI-powered backend systems. I architect and deploy production-grade AI applications — spanning NLP, healthcare interoperability standards, and multi-agent orchestration — turning research into real, working software. Let's build something incredible together!";
                    ...
                    <FadeIn delay={0.15} className="w-full max-w-3xl">
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {[
                          ...
                          {
                            label: 'AI / ML & NLP',
                            items: ['RAG', 'NLP', 'OpenAI API', 'Groq (Llama 3.1)', 'AI Agents', 'Transformers', 'Prompt Engineering'],
                          },
                          {
                            label: 'Backend & APIs',
                            items: ['FastAPI', 'REST APIs', 'JWT', 'bcrypt', 'SQLite', 'Streamlit'],
                          },
                          {
                            label: 'Data Science',
                            items: ['Pandas', 'NumPy', 'Scikit-learn', 'EDA', 'Feature Engineering'],
                          },
                          {
                            label: 'Standards & Tools',
                            items: ['FHIR R4', 'NIH RxNorm API', 'Git', 'GitHub', 'Linux', 'CUDA basics'],
                          },
                        ].map((group) => (
                          <div
                            key={group.label}
